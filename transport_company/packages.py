...
class Packages:
    ...
    def create_packages(self):
        ...
        with open(self.packages_file, 'r') as f:
            for line in f:
                ...
                package_id, start_station, end_station, time_available = line[0], line[1], line[2], dt.datetime.strptime(
                    line[3], "%H:%M").time()
                if start_station == end_station:
                    continue
                time_available = dt.timedelta(
                    seconds=3600 * time_available.hour + 60 * time_available.minute)
                self.add_package(package_id, start_station,
                                 end_station, time_available)
    ...
    def add_package(self, package_id, start_station, end_station, time_available):
        ...
        new_package = Package(package_id, start_station,
                              end_station, time_available)
